...
export const coupons = pgTable("coupons", {
	...
	discountValue: numeric("discount_value", { precision: 10, scale: 2, mode: 'number' }).default(0).notNull(),
	minOrderAmount: numeric("min_order_amount", { precision: 10, scale: 2, mode: 'number' }).default(0).notNull(),
...
export const orderItems = pgTable("order_items", {
	...
	price: numeric({ precision: 12, scale: 2, mode: 'number' }).default(0).notNull(),
	quantity: integer().default(1).notNull(),
	total: numeric({ precision: 12, scale: 2, mode: 'number' }).default(0).notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	taxRate: numeric("tax_rate", { precision: 6, scale: 3, mode: 'number' }).default(0).notNull(),
	taxAmount: numeric("tax_amount", { precision: 12, scale: 2, mode: 'number' }).default(0).notNull(),
...
export const orders = pgTable("orders", {
	...
	subtotal: numeric({ precision: 12, scale: 2, mode: 'number' }).default(0).notNull(),
	tax: numeric({ precision: 12, scale: 2, mode: 'number' }).default(0).notNull(),
	shipping: numeric({ precision: 12, scale: 2, mode: 'number' }).default(0).notNull(),
	discount: numeric({ precision: 12, scale: 2, mode: 'number' }).default(0).notNull(),
	total: numeric({ precision: 12, scale: 2, mode: 'number' }).default(0).notNull(),
...
export const productVariants = pgTable("product_variants", {
	...
	sortOrder: integer("sort_order").default(0).notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	basePrice: numeric("base_price", { precision: 10, scale: 2, mode: 'number' }).default(0).notNull(),
	sellingPrice: numeric("selling_price", { precision: 10, scale: 2, mode: 'number' }).default(0).notNull(),
	imageUrl: text("image_url"),
	images: text().array().default([""]).notNull(),
	specialPrice: numeric("special_price", { precision: 10, scale: 2, mode: 'number' }),
	storeId: uuid("store_id").notNull(),
...
export const taxClasses = pgTable("tax_classes", {
	...
	storeId: uuid("store_id").notNull(),
	name: text().notNull(),
	rate: numeric({ precision: 6, scale: 3, mode: 'number' }).default(0).notNull(),
	sortOrder: integer("sort_order").default(0).notNull(),
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
	updatedAt: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow().notNull(),
}, (table) => [
