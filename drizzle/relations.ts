...
import { stores, admins, aiCreditBalances, aiCreditLedger, aiCreditPurchases, blogCategories, blogs, blogComments, users, blogLikes, blogTags, cardColors, categories, coupons, customerAddresses, emailCampaigns, emailCampaignRecipients, enquiries, homepageSections, orders, orderItems, products, productVariants, planEvents, productReviews, taxClasses, roles, stockMovements, storeBillingSettings, storeBrandProfiles, storeCounters, storeMenus, storePages, storePaymentProviders, storeSubscriptions, userGroups, aiUsage, couponUserGroups, userGroupMembers } from "./schema";
...
export const aiCreditPurchasesRelations = relations(aiCreditPurchases, ({one}) => ({
	store: one(stores, {
...
export const storeBillingSettingsRelations = relations(storeBillingSettings, ({one}) => ({
	taxClass: one(taxClasses, {
...
export const storeBrandProfilesRelations = relations(storeBrandProfiles, ({one}) => ({
	store: one(stores, {
...
export const storePaymentProvidersRelations = relations(storePaymentProviders, ({one}) => ({
	store: one(stores, {
...
export const couponUserGroupsRelations = relations(couponUserGroups, ({one}) => ({
	coupon: one(coupons, {
