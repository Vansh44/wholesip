...
export function designToCssVars(
  ...
  return {
    ...
    "--wholesip-cream": p.cream,
    "--wholesip-cream-deep": p.creamDeep,
    "--wholesip-surface": p.surface,
    "--wholesip-ink": p.ink,
    "--wholesip-ink-soft": p.inkSoft,
    "--wholesip-ink-faint": p.inkFaint,
    "--wholesip-taupe": p.taupe,
    "--wholesip-sand": p.sand,
    "--wholesip-butter": p.butter,
    "--wholesip-border": p.border,
    "--wholesip-tile": p.tile,
    "--wholesip-accent-warm": p.accentWarm,
    "--wholesip-on-accent": p.onAccent,
    "--wholesip-on-ink": p.onInk,
    "--wholesip-shadow-rgb": p.shadowRgb,
    "--wholesip-success": p.success,
    "--wholesip-success-soft": p.successSoft,
    "--wholesip-error": p.error,
    "--wholesip-error-soft": p.errorSoft,
    "--wholesip-star": p.star,
    "--wholesip-highlight": p.highlight,
    ...(p.accentDeep ? { "--wholesip-accent-deep": p.accentDeep } : {}),
    ...
    "--wholesip-radius-card": design.shape.card,
    "--wholesip-radius-control": design.shape.control,
    "--wholesip-radius-sm": design.shape.sm,
    "--wholesip-radius-pill": design.shape.pill,
  };
}
