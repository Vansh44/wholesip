-- =============================================================
-- Enforce unique emails on admins
-- `admins.email` had no uniqueness guarantee, so two auth accounts could
...
--   DELETE FROM admins WHERE id = '<redundant-profile-id>';
--   -- or remove the whole auth account (cascades to admins):
